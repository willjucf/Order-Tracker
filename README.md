# Order Tracker v1.2.1

Desktop app that scans your email for Walmart orders and tracks status, spending, and item stick rates.
...
```
release/Order Tracker Setup 1.2.1.exe
```
